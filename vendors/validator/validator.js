...
;(function(root, factory){
    ...
    FormValidator.prototype = {
        ...
        texts : {
            invalid         : 'La entrada no es la esperada',
            short           : 'La entrada es demasiado corta',
            long            : 'La entrada es demasiado larga',
            checked         : 'must be checked',
            empty           : 'Por favor, este es obligatorio',
            select          : 'Por favor seleccione una opción',
            number_min      : 'Demasiado baja',
            number_max      : 'Demasiado alto',
            url             : 'invalid URL',
            number          : 'No un número',
            email           : 'Dirección de correo electrónico es inválida',
            email_repeat    : 'emails do not match',
            date            : 'invalid date',
            time            : 'invalid time',
            password_repeat : 'passwords do not match',
            no_match        : 'no match',
            complete        : 'La entrada no está completa'
        },
