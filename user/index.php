  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        ...
        <h1 class="text-light"><a href="index.php">SERVICIO EDUCACIONAL HOGAR Y SALUD <span>.</span></a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
      </div>

      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="get-started"><a href="consulta.php">Consulta</a></li>
        </ul>
      </nav><!-- .nav-menu -->
  ...
  <section id="hero">
    ...
    <div class="container">
      ...
      <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
        <h1>BIENVENIDO</h1>
        <h2>Inscribite a la campaña para colportaje</h2>
        <a href="formulario.php" class="btn-get-started scrollto">Inscribite </a>
      </div>
      <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left">
        <img src="assets/img/banner-sueno-grande.jpg" class="img-fluid" alt="">
      </div>
    </div>
    </div>
