...
class ModeloAdministrador extends mainModel
{
	protected function agregar_administrador_modelo($datos)
	{
		$sql= mainModel::conectar()->prepare("INSERT INTO `admin`(`AdminDNI`, `AdminNombre`, `AdminApellido`, `AdminGenero`, `AdminEmail`, `AdminTelefono`, `AdminDireccion`, `AdminMisionId`, `CuentaCodigo`) VALUES (:DNI, :Nombre, :Apellido, :Genero, :Email, :Telefono, :Direccion, :Mision, :Codigo)");
	...
	public function eliminar_administrador_modelo($codigo)
	{
	...
	{
		$query = mainModel::conectar()->prepare("UPDATE admin SET AdminDNI=:DNI, AdminNombre=:Nombre, AdminApellido=:Apellido, AdminTelefono=:Telefono, AdminDireccion=:Direccion, AdminMisionId=:Mision WHERE  CuentaCodigo=:Codigo");
		...
		$query->bindParam(":Mision", $datos['Mision']);
